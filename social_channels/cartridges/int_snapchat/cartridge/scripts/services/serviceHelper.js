/**
 * Service Helper for Snapchat services.
 */
...
function getServiceID(name, serviceCallback) {
    var Logger = require('dw/system/Logger').getLogger('SnapchatServiceHelper', 'getServiceID');
...
var serviceCallback = {
    ...
    getRequestLogMessage: function (request) {
        require('dw/system/Logger').getLogger('Snapchat', 'serviceHelper').debug('Snapchat serviceHelper.getRequestLogMessage: ' + JSON.stringify(request));
    },
    getResponseLogMessage: function (response) {
        require('dw/system/Logger').getLogger('Snapchat', 'serviceHelper').debug('Snapchat serviceHelper.getResponseLogMessage: ' + JSON.stringify(response.getText()));
    }
};
